...
teamNamesCasual= {"ATL":"hawks","BOS":"celtics","BKN":"nets","CHA":"hornets","CHI":"bulls","CLE":"cavs","DAL":"mavs","DEN":"nuggets","DET":"pistons","GS":"warriors","HOU":"rockets","IND":"pacers","LAC":"clippers","LAL":"lakers","MEM":"grizzlies","MIA":"heat","MIL":"bucks","MIN":"t-wolves","NO":"pelicans","NY":"knicks","OKC":"thunder","ORL":"magic","PHI":"76ers","PHO":"suns","POR":"blazers","SAC":"kings","SA":"spurs","TOR":"raptors","UTA":"jazz","WAS":"wizards"}
teamNames= {"ATL":"Hawks","BOS":"Celtics","BKN":"Nets","CHA":"Hornets","CHI":"Bulls","CLE":"Cavaliers","DAL":"Mavericks","DEN":"Nuggets","DET":"Pistons","GS":"Warriors","HOU":"Rockets","IND":"Pacers","LAC":"Clippers","LAL":"Lakers","MEM":"Grizzlies","MIA":"Heat","MIL":"Bucks","MIN":"Timberwolves","NO":"Pelicans","NY":"Knicks","OKC":"Thunder","ORL":"Magic","PHI":"76ers","PHO":"Suns","POR":"Blazers","SAC":"Kings","SA":"Spurs","TOR":"Raptors","UTA":"Jazz","WAS":"Wizards"}
...
if __name__ == "__main__":
    ...
    print(schedules)
    saveSchedulesToJSON(schedules, "nba_schedule.json")
